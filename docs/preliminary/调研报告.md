...
近年来，AI，尤其是 LLM 实现了快速发展和广泛应用。从 Chat bot 到 AI Agent，LLM 的应用更加智能化和自主化，因此也更加需要与操作系统交互的能力。在这种背景下，AIOS 应运而生。AIOS 是一个专门为 AI Agent 和 LLM 设计的操作系统，旨在提供高效的资源管理、调度和上下文维护能力。其架构如下 [^mei2024aiosllmagentoperating]：
...
[agi/research/AIOS: AIOS: AI Agent Operating System](https://github.com/agiresearch/AIOS?tab=readme-ov-file)

[agi/research/AIOS-LSFS: From Commands to Prompts: LLM-based Semantic File System for AIOS](https://github.com/agiresearch/AIOS-LSFS)
...
[^mei2024aiosllmagentoperating]: K. Mei, X. Zhu, W. Xu, W. Hua, M. Jin, Z. Li, S. Xu, R. Ye, Y. Ge, and Y. Zhang, "AIOS: LLM Agent Operating System," _arXiv preprint arXiv:2403.16971 [cs.OS]_, 2024. [Online]. Available: https://arxiv.org/abs/2403.16971.